## This project relies on the Galvanize Collective API's. In order for the select message functionality to be persistent, I modified the API. If you would like to see the full functionality, add the below snippet to app/messages/routes.js
